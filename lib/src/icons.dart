...
const Map<BlenderGlyph, String> _blenderIconFileNames = <BlenderGlyph, String>{
  ...
  BlenderGlyph.assetManager: 'asset_manager.svg',
  ...
  BlenderGlyph.mesh: 'mesh_data.svg',
  BlenderGlyph.curve: 'curve_data.svg',
  BlenderGlyph.curves: 'curves_data.svg',
  BlenderGlyph.pointcloud: 'pointcloud_data.svg',
  BlenderGlyph.speaker: 'speaker.svg',
  BlenderGlyph.volume: 'volume_data.svg',
  BlenderGlyph.empty: 'empty_data.svg',
  BlenderGlyph.lightprobe: 'lightprobe_sphere.svg',
  BlenderGlyph.greasepencil: 'greasepencil.svg',
  BlenderGlyph.lattice: 'lattice_data.svg',
  BlenderGlyph.metaball: 'meta_data.svg',
  BlenderGlyph.armature: 'armature_data.svg',
  BlenderGlyph.bone: 'bone_data.svg',
  BlenderGlyph.shaderfx: 'shaderfx.svg',
  BlenderGlyph.viewLayer: 'renderlayers.svg',
  BlenderGlyph.camera: 'camera_data.svg',
  BlenderGlyph.light: 'light.svg',
  BlenderGlyph.material: 'material.svg',
  BlenderGlyph.gizmo: 'gizmo.svg',
  BlenderGlyph.overlay: 'overlay.svg',
  BlenderGlyph.xray: 'xray.svg',
  BlenderGlyph.solid: 'shading_solid.svg',
  BlenderGlyph.materialPreview: 'shading_texture.svg',
  BlenderGlyph.rendered: 'shading_rendered.svg',
  BlenderGlyph.modifier: 'modifier.svg',
  BlenderGlyph.physics: 'physics.svg',
  ...
  BlenderGlyph.undo: 'loop_back.svg',
  BlenderGlyph.redo: 'loop_forwards.svg',
  ...
  BlenderGlyph.sync: 'uv_sync_select.svg',
  ...
  void paint(Canvas canvas, Size size) {
    ...
    switch (glyph) {
      ...
      case BlenderGlyph.shaderfx:
        canvas.drawRect(
          Rect.fromLTWH(w * .14, h * .18, w * .72, h * .64),
          paint,
        );
        canvas.drawLine(
          Offset(w * .28, h * .36),
      ...
      case BlenderGlyph.overlay:
        canvas.drawRect(
          Rect.fromLTWH(w * .18, h * .24, w * .48, h * .48),
          paint,
        );
        canvas.drawRect(
          Rect.fromLTWH(w * .34, h * .4, w * .48, h * .48),
          paint,
        );

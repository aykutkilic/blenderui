...
| `example/lib/showcase/` | Blender-application imitation composed from the public package. It owns fixtures and fake outcomes. |
| `example/lib/demo/` | Smaller component tutorials and API demonstrations. |
| `test/`, `example/test/` | Package contracts and integration/visual-baseline behavior, split into registered feature parts. |
...
6. Record a lasting boundary change in `doc/decisions/` and the dated outcome
   in `doc/development-history.md`.

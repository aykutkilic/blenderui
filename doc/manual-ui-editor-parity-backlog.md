...
| Timeline | `editors_timeline_interface.png` | `space_time.py`, `space_action/` | shared Dope/Timeline header, `BlenderTimeline`, playback footer | **Covered:** source-conditioned header/popovers and a rendered reference are committed. |
